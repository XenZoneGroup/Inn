  ...
  return (
    <ContentSection className="need-to-talk">
      ...
      <div className="unstack-left">
        ...
        <ul>
          <li>
            <span className="time">12pm - 10pm</span> weekdays
          </li>
          <li>
            <span className="time">6pm - 10pm</span> weekends
          </li>
          <li>
            <span className="time">4pm - 8pm</span> public holidays
          </li>
        </ul>
      </div>
      <div className="unstack-right">
        <p className="extra-details">
          ...
          {frontendRoot.state === 'LOADED' && (
            <>
              &nbsp;
              <a href={urljoin(frontendRoot.value, '/SOME_PARTNER/sign-up/')}>
                Sign up to try
              </a>
            </>
          )}
        </p>
        <Link className="secondary-cta alternate" to="/in-crisis">
          IN CRISIS?
        </Link>
      </div>
    </ContentSection>
